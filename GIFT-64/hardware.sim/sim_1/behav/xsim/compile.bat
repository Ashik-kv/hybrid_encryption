...
REM
REM Generated by Vivado on Tue Mar 24 20:32:50 +0530 2026
...
echo "xvhdl --incr --relax -prj tb_gift64_core_vhdl.prj"
call xvhdl  --incr --relax -prj tb_gift64_core_vhdl.prj -log xvhdl.log
